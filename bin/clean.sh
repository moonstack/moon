...
chown moon:moon $myCOWRIETTYTGZ $myCOWRIEDLTGZ $myDIONAEABITGZ $myDIONAEABINTGZ $myHONEYTRAPATTACKSTGZ $myHONEYTRAPDLTGZ
...
chown moon:moon $myCOWRIETTYLOGS $myCOWRIEDL $myDIONAEABI $myDIONAEABIN $myHONEYTRAPATTACKS $myHONEYTRAPDL
...
fuEMOBILITY () {
  ...
  chown moon:moon /data/emobility -R
}
...
fuVNCLOWPOT () {
  ...
  chown moon:moon /data/vnclowpot/ -R
}
